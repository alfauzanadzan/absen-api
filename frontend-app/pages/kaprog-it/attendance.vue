  ...
  <div class="flex h-screen bg-white">
    ...
    <aside class="w-60 bg-white p-6 flex flex-col">
      ...
      <nav class="flex flex-col space-y-2">
        ...
        <a href="/kaprog-it/profilkaprog" class="p-2 rounded hover:bg-gray-400">Profile</a>
        <a href="/kaprog-it/employees" class="p-2 rounded hover:bg-gray-400">Employees</a>
        <a href="/kaprog-it/attendance" class="p-2 rounded bg-blue-50 text-blue-600 font-medium">Attendance</a>
        <a href="/kaprog-it/reports" class="p-2 rounded hover:bg-gray-400">Reports</a>
      </nav>
    </aside>
...
async function saveEdit() {
  ...
  // TODO: kirim PATCH ke API di sini kalau mau update database
  closeModal()
}
