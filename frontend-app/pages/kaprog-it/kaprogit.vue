  ...
  <div class="flex h-screen bg-white">
    ...
    <aside class="w-60 bg-white p-6 flex flex-col">
      ...
      <nav class="flex flex-col space-y-2">
        ...
        <a href="/kaprog-it/profilkaprog" class="p-2 rounded hover:bg-gray-200">Profile</a>
        <a href="/kaprog-it/employees" class="p-2 rounded hover:bg-gray-200">Employees</a>
        <a href="/kaprog-it/attendance" class="p-2 rounded hover:bg-gray-200">Attendance</a>
        <a href="/kaprog-it/reports" class="p-2 rounded hover:bg-gray-200">Reports</a>
      </nav>
    </aside>
