  ...
  <div class="flex h-screen bg-gray-50">
    ...
    <aside class="w-60 bg-white p-6 flex flex-col shadow">
      ...
      <nav class="flex flex-col space-y-2">
        <a href="/pekerja-marketing/pekerjamarketing" class="p-2 rounded hover:bg-gray-200">🏠 Dashboard</a>
        <a href="/pekerja-marketing/checkin" class="p-2 rounded hover:bg-gray-200">🕓 Check-in</a>
        <a
