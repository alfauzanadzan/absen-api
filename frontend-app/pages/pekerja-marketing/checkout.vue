  ...
  <div class="flex h-screen bg-gradient-to-br from-gray-400 via-gray-300 to-gray-500">
    ...
    <aside class="w-64 bg-white/30 backdrop-blur-md p-6 flex flex-col shadow-lg border-r border-white/30">
      <div class="flex items-center justify-center h-20 mb-8">
        <h1 class="text-xl font-extrabold text-white drop-shadow-lg tracking-wide">PEKERJA Marketing</h1>
      </div>

      <nav class="flex flex-col space-y-3 text-white font-medium">
        <a href="/pekerja-marketing/pekerjamarketing" class="p-3 rounded-lg hover:bg-white/20 transition">🏠 Dashboard</a>
        <a href="/pekerja-marketing/checkin" class="p-3 rounded-lg hover:bg-white/20 transition">🕓 Check-in</a>
        <a href="/pekerja-marketing/checkout" class="p-3 rounded-lg bg-white/30 text-white shadow hover:bg-white/40 transition">⏰ Check-out</a>
      </nav>
    </aside>
