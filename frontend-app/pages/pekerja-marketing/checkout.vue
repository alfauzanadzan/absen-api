...
const postCheckout = async (payload: { userId: string; role: string; qrValue: string }) => {
  ...
  try {
    ...
    setTimeout(() => {
      ...
      else if (user.value?.role === 'PEKERJA') router.push('/pekerja-marketing/pekerjamarketing')
      ...
      <div class="w-full max-w-2xl">
        ...
        <div class="flex items-center justify-between mb-6">
          <div>
            ...
            <p class="text-sm text-gray-500">Arahkan kamera ke QR Code department Marketing Anda</p>
