  ...
  <div class="flex h-screen bg-white">
    ...
    <aside class="w-60 bg-white p-6 flex flex-col">
      ...
      <nav class="flex flex-col space-y-2">
        ...
        <a href="/kaprog-marketing/employees" class="p-2 rounded bg-blue-50 text-blue-600 font-medium">Employees</a>
        <a href="/kaprog-marketing/attendance" class="p-2 rounded hover:bg-gray-400">Attendance</a>
        ...
        <table class="min-w-full text-sm">
          <thead class="bg-gray-100">
            <tr class="border-b">
              ...
              <th class="text-left px-6 py-4 font-semibold text-right">Action</th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="(emp, idx) in employees" :key="emp.id" class="border-b hover:bg-gray-50">
              <td class="px-6 py-4">
                <img
...
function importPdf() {
  alert(
    'Fungsi Import PDF: implementasi tergantung requirement (upload file dan parsing).'
  )
}
</script>
