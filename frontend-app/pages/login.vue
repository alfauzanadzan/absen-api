    ...
    <div class="w-full max-w-md mx-auto">
      <div class="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl border p-6 md:p-8">
        ...
        <form @submit.prevent="handleLogin" class="space-y-4" novalidate>
          <div>
            ...
            <input
              ...
              class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                class="block w-full rounded-md border border-gray-300 px-3 py-2.5 pr-24 focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="Masukkan password"
              />
              <button
                type="button"
                @click="showPassword = !showPassword"
                class="absolute right-2 top-1/2 -translate-y-1/2 text-sm text-slate-600 hover:text-slate-800"
              >
          ...
          <div v-if="error" class="mt-2 p-3 bg-red-50 border border-red-200 rounded text-red-700 text-sm">
            {{ error }}
          </div>
        </form>
        ...
        <div class="mt-6 text-center text-xs text-slate-400">
          © {{ new Date().getFullYear() }} Absen Scan • v1.0
        </div>
