  ...
  <div class="flex h-screen bg-white-100">
    ...
    <aside class="w-60 bg-white p-6 flex flex-col shadow-md">
      ...
      <nav class="flex flex-col space-y-2">
        <NuxtLink to="/admin/admin" class="p-2 rounded hover:bg-gray-200">Dashboard</NuxtLink>
        <NuxtLink to="/admin/profiladmin" class="p-2 rounded hover:bg-gray-200">Profile</NuxtLink>
        <NuxtLink to="/admin/employees" class="p-2 rounded hover:bg-gray-200">Employees</NuxtLink>
        <NuxtLink to="/admin/attendance" class="p-2 rounded hover:bg-gray-200">Attendance</NuxtLink>
        <NuxtLink to="/admin/schedule" class="p-2 rounded hover:bg-gray-200">Schedule</NuxtLink>
        <NuxtLink to="/admin/reports" class="p-2 rounded hover:bg-gray-200">Reports</NuxtLink>
      </nav>
    </aside>
